...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{PERFCOMP_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{PERFCOMP_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
perfcomp_server.pl - Catalyst Testserver

=head1 SYNOPSIS

perfcomp_server.pl [options]
